...
function controlSubfield1PermitsMerge(field1, field2) {
  if (!fieldHasSubfield(field1, '1', null) && !fieldHasSubfield(field2, '1', null)) {
    return true;
  }
  // Same result, but log:
...
function controlSubfield6PermitsMerge(field1, field2) {
  if (!fieldHasSubfield(field1, '6') && !fieldHasSubfield(field2, '6')) {
    return true;
  }
...
function controlSubfield8PermitsMerge(field1, field2) {
  return !fieldHasSubfield(field1, '8') && !fieldHasSubfield(field2, '8');
}
...
function controlSubfield0PermitsMerge(field1, field2) {
  if (!fieldHasSubfield(field1, '0', null) || !fieldHasSubfield(field2, '0', null)) {
    return true;
  }
